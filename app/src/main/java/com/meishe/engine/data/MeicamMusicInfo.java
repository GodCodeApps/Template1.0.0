...
public class MeicamMusicInfo implements Serializable {
    ...
    public MeicamMusicInfo clone() {
        MeicamMusicInfo meicamMusicInfo = new MeicamMusicInfo();
        meicamMusicInfo.setFileUrl(getFileUrl());
        meicamMusicInfo.setFilePath(getFilePath());
        meicamMusicInfo.setDuration(getDuration());
        meicamMusicInfo.setArtist(getArtist());
        meicamMusicInfo.setImage(getImage());
        meicamMusicInfo.setImagePath(getImagePath());
        meicamMusicInfo.setTitle(getTitle());
        meicamMusicInfo.setTrimIn(getTrimIn());
        meicamMusicInfo.setTrimOut(getTrimOut());
        meicamMusicInfo.setMimeType(getMimeType());
        meicamMusicInfo.setIsAsset(isAsset());
        meicamMusicInfo.setPrepare(isPrepare());
        meicamMusicInfo.setPlay(isPlay());
        meicamMusicInfo.setIsHttpMusic(isHttpMusic());
        meicamMusicInfo.setAssetPath(getAssetPath());
        meicamMusicInfo.setInPoint(getInPoint());
        meicamMusicInfo.setOutPoint(getOutPoint());
        meicamMusicInfo.setVolume(getVolume());
        meicamMusicInfo.setOriginalInPoint(getOriginalInPoint());
        meicamMusicInfo.setOriginalOutPoint(getOriginalOutPoint());
        meicamMusicInfo.setOriginalTrimIn(getOriginalTrimIn());
        meicamMusicInfo.setOriginalTrimOut(getOriginalTrimOut());
        meicamMusicInfo.setExtraMusic(getExtraMusic());
        meicamMusicInfo.setExtraMusicLeft(getExtraMusicLeft());
        meicamMusicInfo.setFadeDuration(getFadeDuration());
        meicamMusicInfo.setLrcPath(getLrcPath());
        return meicamMusicInfo;
    }
