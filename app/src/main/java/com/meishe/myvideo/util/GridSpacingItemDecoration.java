...
public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    int marginSizeMiddle = ((int) MeiSheApplication.getContext().getResources().getDimension(R.dimen.select_item_between));
    int marginSizeStart = ((int) MeiSheApplication.getContext().getResources().getDimension(R.dimen.select_item_start_end));
    ...
    public GridSpacingItemDecoration(Context context, int i) {
        this.spanCount = i;
        this.screenWidth = ScreenUtils.getScreenWidth(context) - (((int) MeiSheApplication.getContext().getResources().getDimension(R.dimen.select_recycle_marginLeftAndRight)) * 2);
    ...
    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        if (this.screenWidth - (this.spanCount * this.itemWidth) > 0) {
            int dip2px = ScreenUtils.dip2px(MeiSheApplication.getContext(), 3.0f);
