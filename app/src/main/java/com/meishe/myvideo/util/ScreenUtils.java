...
public class ScreenUtils {
    ...
    public static boolean hasNavigationBar(Activity activity) {
        ...
        Math.sqrt(Math.pow((double) displayMetrics2.widthPixels, 2.0d) + Math.pow((double) mScreenRealHeight, 2.0d));
    ...
    public static boolean checkDeviceHasNavigationBar(WindowManager windowManager) {
        ...
        return mScreenRealHeight - displayMetrics.widthPixels > 0;
    }
    ...
    public static int getStatusBarViewHeight(Context context) {
        try {
