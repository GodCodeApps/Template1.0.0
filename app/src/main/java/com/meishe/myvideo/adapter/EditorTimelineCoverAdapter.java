...
public class EditorTimelineCoverAdapter extends RecyclerView.Adapter {
    private static final String TAG = "EditorTimelineCoverAdapter";
    ...
    public EditorTimelineCoverAdapter(Context context, int i, int i2, List<NvsVideoClip> list, double d) {
    ...
    private void init(List<NvsVideoClip> list) {
        ...
        for (NvsVideoClip nvsVideoClip : list) {
            ...
            double outPoint = (double) nvsVideoClip.getOutPoint();
